...
export class CounterpartyModal {
    /**
     * Creates an instance of CounterpartyModal.
     * 
     * @param {function(Counterparty): void} onSave - Callback function called when form is submitted
     * @throws {Error} If required DOM elements are not found
     */
    constructor(onSave) {
        this.onSave = onSave;
        this.modal = document.getElementById('counterparty-modal');
        this.form = document.getElementById('counterparty-form');
